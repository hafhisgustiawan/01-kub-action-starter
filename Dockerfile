...
# KEMUDIAN SECARA DEFAULT, IP CLUSTER AKAN DIBUAT, CEK : kubectl get services. TETAPI INI GAKBISA DI AKSES DARI LUAR SEBELUM DI EXPOSE DENGAN CARA BUAT SERVICE BARU
